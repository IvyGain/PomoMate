...
export const CHARACTER_EVOLUTIONS: Record<string, Character> = {
  ...
  balanced_2: { 
    id: 'balanced_2',
    name: 'ポモリン', 
    description: '時間の精霊が成長し、調和の力を得た姿', 
    level: 2,
  ...
  focused_2: { 
    id: 'focused_2',
    name: 'フォーカス', 
    description: '集中の結晶が成長し、深い洞察力を得た', 
    level: 2,
  ...
  balanced_balanced_balanced_3: { 
    ...
    name: 'ポモディア', 
    description: '時間の守護者として覚醒した調和の化身', 
    level: 3,
  ...
  consistent_consistent_consistent_3: { 
    ...
    name: 'コンスタンツァ', 
    description: '永遠の炎が強大な力となり、不滅の意志を宿す', 
    level: 3,
  ...
  balanced_balanced_balanced_balanced_balanced_5: {
    ...
    name: 'ポモディウス',
    description: '時の神として覚醒し、全てを調和させる存在',
    level: 5,
  ...
  ninja_focused_3: {
    id: 'ninja_focused_3',
    name: 'シノビ・フォウ',
    description: '忍者の精神を宿し、影のように集中する',
    level: 3,
    evolutionPath: ['focused', 'focused', 'focused'],
    nextEvolutionExp: 1500,
  ...
  samurai_consistent_3: {
    ...
    name: 'ブシドウ・コン',
    description: '武士道の精神を体現し、不動の意志を貫く',
    level: 3,
    evolutionPath: ['consistent', 'consistent', 'consistent'],
    nextEvolutionExp: 1500,
  ...
  dragon_balanced_4: {
    ...
    name: 'リュウジン',
    description: '龍神の力を宿し、天地を調和させる存在',
    level: 4,
    evolutionPath: ['balanced', 'balanced', 'balanced', 'balanced'],
    nextEvolutionExp: 2000,
  ...
  phoenix_consistent_4: {
    ...
    name: 'ホウオウ',
    description: '鳳凰の再生力を得て、永遠に続く意志を宿す',
    level: 4,
