...
interface SocialState {
  ...
  updateFriendStatus: (friendId: string, status: 'オンライン' | 'オフライン') => void;
  handleIncomingFriendRequest: (request: FriendRequest) => void;
  handleFriendRequestAccepted: (friendData: Friend) => void;
}
  ...
  persist(
    (set, get) => ({
      ...
      initializeSocketListeners: async () => {
        // Initialize realtime listeners using Supabase
        console.log('Initializing social realtime listeners');
        
        // TODO: Implement Supabase realtime listeners for:
        // - Friend requests
